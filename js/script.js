...
(function($) {
	...
	var Upsite = {
		...
		MobileMenu: function() {
			var navMenu	= '<nav id="navigation_mobile"><span id="mobile-logoxix">' + $('.navbar-brand').html() + '</span><button class="nav-menu-toggle xixmobster aamob"><i class="fa fa-navicon"></i></button>';//xix fix appended navbar-brand html
			navMenu		+= '<div class="nav-menu-links">';
			navMenu		+= '<div class="nav-menu-button"><button class="nav-menu-toggle xixmobster"><i class="fa fa-navicon"></i></button></div>';
			navMenu		+= '<ul>';
			...
			$('.xixmobster').on('click', function() {
			    ...
			    $('.nav-menu-links').animate({
			       right: '0px'
			    }, { duration: 200, queue: false });
			    $(".nav-menu-toggle i.fa").removeClass("fa-navicon");
			    $(".nav-menu-toggle i.fa").addClass("fa-close");
			    $(".aamob").hide();
			    mobilexixopen = 1;
			    }
			    else{
			    ...
			    $(".nav-menu-toggle i.fa").removeClass("fa-close");
			    $(".nav-menu-toggle i.fa").addClass("fa-navicon");
			    $(".aamob").show();
			    mobilexixopen = 0;			    
			    }

			});
            $('.nav-menu-links ul li').on('click', function() {
			    $('.nav-menu-links').animate({
			       right: '-230px'
			    }, { duration: 200, queue: false });            	
            	$("body").animate({
